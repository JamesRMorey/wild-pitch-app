...
import MapPointOfInterestOverviewScreen from '../screens/map/point-of-interest-overview';
...
export default function MapStack({}) {
    ...
    return (
        <Stack.Navigator>
            ...
            <Stack.Screen name="map-point-of-interest-overview" component={MapPointOfInterestOverviewScreen} options={{...SCREEN_OPTIONS, presentation: 'formSheet', sheetAllowedDetents: 'fitToContents' }}/>
